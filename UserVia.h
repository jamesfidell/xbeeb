...
extern  unsigned char       ReadUserVia ( int );
extern  void				WriteUserVia ( int, unsigned char );
extern	void				UserViaSetInterrupt ( unsigned char );
extern	void				UserViaClearInterrupt ( unsigned char );
